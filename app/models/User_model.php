...
class User_model{
    ...
    // }
    public function tambah($data){
        $query = "INSERT INTO user (nama, username, password, role, photo_path) VALUES (:nama, :username, :password, :role, :photo_path)";
    ...
    public function prosesUbah($data){
        $query = "UPDATE user SET nama = :nama, username = :username, password = :password, role = :role, photo_path = :photo_path WHERE ID_User = :ID_User";
    ...
    private function uploadPhoto(){
        ...
        if ($fileError === UPLOAD_ERR_OK) {
            ...
            return $destination; // Mengembalikan path relatif gambar
        } else {
            return null;
        }
    }        
